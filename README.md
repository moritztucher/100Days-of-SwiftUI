...
* Day 2 – Booleans, string interpolation, and checkpoint 
* Day 3 – Arrays, dictionaries, sets, and enums
* Day 4 – type annotations and checkpoint 
* Day 5 – if, switch, and the ternary operator
* Day 6 – loops, summary, and checkpoint 
* Day 7 – functions, parameters, and return values
* Day 8 – default values, throwing functions, and checkpoint 
* Day 9 – closures, passing functions into functions, and checkpoint 
* Day 10 – structs, computed properties, and property observers
* Day 11 – access control, static properties and methods, and checkpoint 
* Day 12 – classes, inheritance, and checkpoint 
* Day 13 – protocols, extensions, and checkpoint 
* Day 14 – optionals, nil coalescing, and checkpoint 
